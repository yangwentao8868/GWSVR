function [mse,bestc,bestg] = SVMcgGWForRegress(train_label,train,weight,cmin,cmax,gmin,gmax,v,cstep,gstep,msestep)
...
for i = 1:m
    for j = 1:n
        ...
        cg(i,j) = svmtrain(weight',train_label, train, cmd);
